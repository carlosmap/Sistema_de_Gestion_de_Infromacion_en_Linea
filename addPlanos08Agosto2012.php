...
if(trim($recarga) == "2" ){
	...
	$sqlV = " SELECT COUNT(*) AS siHay FROM Planos WHERE numeroPlano = '" . $nombrePlano . "' ";
	...
	$sqlIn2 = $sqlIn2 . " '" . $archivoPDF_name . "', ";
	$sqlIn2 = $sqlIn2 . " '" . $archivoFte_name . "', ";
	...
	<tr>
	  ...
	  <table width="100%" cellspacing="1">
        <tr>
          ...
          <td class="TxtTabla"><input name="nombrePlano" type="text" class="CajaTexto" id="nombrePlano" size="60" />
            <br />
