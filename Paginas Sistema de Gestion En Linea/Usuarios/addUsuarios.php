...
if (trim($recarga)=="2") {
	$qry = "INSERT INTO Usuarios (loginUsuario, claveUsuario, nombreUsuario, apellidoUsuario, idPerfil, esActivo) ";	
	$qry = $qry . " VALUES ( " ;
	$qry = $qry . " '".$nombreUsuario."', " ;
	$qry = $qry . " '".$contraUsuario."', " ;
	$qry = $qry . " '".$Nombre."', " ;
	$qry = $qry . " '".$Apellido."', " ;
	$qry = $qry . " ".$claseP.", " ;
	$qry = $qry . " '".$estado."' " ;
          ...
          <table width="100%"  border="0" cellspacing="1" cellpadding="0">
		   <form action="" method="post" name="form1" onSubmit="MM_validateForm('Nombre','','R','Apellido','','R','nombreUsuario','','R','contraUsuario','','R');return document.MM_returnValue">
			...
			<tr>
			  ...
			  <td class="TxtTabla"><input name="nombreUsuario" type="text" class="CajaTexto" id="nombreUsuario" value="<? echo $nombreUsuario ?>" size="70" maxlength="15"></td>
			  </tr>
			<tr>
			...
			<tr>
			  ...
			  <td class="TxtTabla"><select name="estado" class="CajaTexto" id="estado">
			...
			<tr>
			  ...
			  <?php while ($reg1 = mssql_fetch_array($cursor1)) { ?>
                <option value="<?php echo $reg1['idPerfil']; ?>" ><?php echo $reg1['nombrePerfil']; ?></option>
			  <? } ?>	
              </select></td>
              </tr>
