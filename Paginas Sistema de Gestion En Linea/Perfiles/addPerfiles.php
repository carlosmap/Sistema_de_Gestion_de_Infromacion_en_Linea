...
if(isset($recarga) && trim($recarga) == "1"){
	$sqlIn1 = " INSERT INTO Perfiles (nombrePerfil, relativoA) ";
	$sqlIn1 = $sqlIn1 . " VALUES ( ";
	$sqlIn1 = $sqlIn1 . " '" . $nombrePerfil . "', ";
	$sqlIn1 = $sqlIn1 . " '" . $relativoA . "' ";
	$sqlIn1 = $sqlIn1 . " ) ";
	...
	<tr>
	  ...
	  <table width="100%" cellspacing="1">
        <tr>
          ...
          <td class="TxtTabla"><input name="nombrePerfil" type="text" class="CajaTexto" id="nombrePerfil" size="60" /></td>
        </tr>
        <tr>
          <td class="TituloTabla2">Relativo a </td>
          <td class="TxtTabla"><select name="relativoA" class="CajaTexto" id="relativoA">
