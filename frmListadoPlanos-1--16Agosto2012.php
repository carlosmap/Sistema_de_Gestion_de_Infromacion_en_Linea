...
//echo 	$_SESSION["phsProyecto"];
//echo $_SESSION["phsEtapa"];
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#276074">
  ...
  <tr align="center">
	...
	<table width="70%" cellspacing="1">
      ...
      <tr>
        <td colspan="2" align="right" class="TxtTabla"><input name="pagina" type="hidden" id="pagina" value="<? echo $pagina; ?>">
    ...
    <td><table width="100%" cellspacing="1">
	  ...
	  <tr class="TxtTabla">
		...
		<?
			...
			$comunicacion_revision="R".$regA[letraRevisionInterna]."com"
		?>
		...
		<? while($regA1 = mssql_fetch_array($cursorA1)){ ?>
          <tr>
            ...
            <td width="33%" align="center">(<a href="#"><img src="../images/ver.gif" width="16" height="16" border="0" onClick="MM_openBrWindow('<? echo $path."/".$comunicacion_revision."/".$regA1[archivoComunicacion]; ?>','','width=800,height=600')"></a>)</td>
          </tr>
		  <? } ?>
        </table>		</td>
