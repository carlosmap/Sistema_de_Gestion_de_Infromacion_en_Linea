      ...
      <tr>
		...
		<table width="100%" cellspacing="1">
          ...
          <tr class="TxtTabla">
			...
			?>
            <td align="center"><?=$pathPDF; ?><a href="#"><img src="../images/icoPDF.gif" alt="Archivo PDF" width="18" height="18" border="0" onClick="MM_openBrWindow('<? echo $pathPDF; ?>','','width=800,height=600')"></a></td>
            <td align="center"><a href="#"><img src="../images/icoDWG.gif" alt="Archivo DWG" width="18" height="18" border="0" onClick="MM_openBrWindow('<? echo $pathDWG; ?>','','width=800,height=600')"></a></td>
